...
<body>
    ...
    <section class="category-page section mt-6">
        <div class="container">
            <div class="row">
                <div class="col-lg-3 col-md-4 col-12">
                    <div class="category-sidebar">
                        ...
                        <div class="single-widget">
                            ...
                            <ul class="list">
                                <li><a href="javascript:void(0)"><i class="lni lni-dinner"></i> Turismo<span>15</span></a></li>
                                <li><a href="javascript:void(0)"><i class="lni lni-control-panel"></i> Servicios <span>20</span></a></li>
                                <li><a href="javascript:void(0)"><i class="lni lni-bullhorn"></i> Marketing <span>55</span></a></li>
                                <li><a href="javascript:void(0)"><i class="lni lni-home"></i> Inmuebles<span>35</span></a></li>
                                <li><a href="javascript:void(0)"><i class="lni lni-bolt"></i> Electrónicos <span>60</span></a></li>
                                <li><a href="javascript:void(0)"><i class="lni lni-tshirt"></i> Ropa<span>55</span></a></li>
                                <li><a href="javascript:void(0)"><i class="lni lni-diamond-alt"></i> Joyería y Accesorios<span>45</span></a></li>
                            </ul>
                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-4 col-md-6 col-12">
                                                ...
                                                <div class="single-item-grid">
                                                    <div class="image">
                                                        <a href="item-details.html"><img src="../assets/images/items-detail/image2.jpg" alt="#"></a>
