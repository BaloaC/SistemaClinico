...
<body>
    ...
    <main>
        <div class="container">
            ...
            <div class="row">
                <div class="col-6">
                    <h1 class="p-4 text-light">Gestion de Empresas</h1>
                </div>
                <div class="col-6 d-flex align-items-center justify-content-end">
                    <button class="btn btn-blue" id="btn-add" data-bs-toggle="modal" data-bs-target="#modalReg">Añadir empresa</button>
                </div>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <form action="" id="info-empresa" class="p-3 px-4">
                            ...
                            <select name="seguro_id" id="seguro_id" class="form-control mb-3" data-active="0">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <form action="" id="act-empresa" class="p-3 px-4">
                            ...
                            <label for="seguro">Seguro</label>
                            <select name="seguro_id" id="seguro_id" class="form-control mb-3" data-active="0">
                                <option value="">Seguro de la empresa</option>
    ...
    <script type="module" src="<?php echo Url::to('assets/js/empresas/scriptPrueba.js'); ?>"></script>
