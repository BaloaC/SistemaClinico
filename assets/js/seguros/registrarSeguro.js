...
async function addSeguro() {
    ...
    try {
        ...
        // if (!(/^(?=.*[^\s])(?=.*[a-zA-Z0-9 @#+_,-])[a-zA-Z0-9 @#+_,-]{1,255}$/.test(data.direccion))) throw { message: "Lsa direccion ingresada no es válida" };
...
document.getElementById("info-seguro").addEventListener('submit', (event) => {
