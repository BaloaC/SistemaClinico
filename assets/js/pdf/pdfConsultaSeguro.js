...
document.getElementById("nombrePaciente").textContent = `${data[0]?.beneficiado?.nombre ?? data[0]?.paciente_beneficiado?.nombre} ${data[0]?.beneficiado?.apellidos ?? data[0]?.paciente_beneficiado?.apellidos}`;
document.getElementById("nombrePaciente2").textContent = `${data[0]?.beneficiado?.nombre ?? data[0]?.paciente_beneficiado?.nombre} ${data[0]?.beneficiado?.apellidos ?? data[0]?.paciente_beneficiado?.apellidos}`;
document.getElementById("cedulaPaciente").textContent = `${data[0]?.beneficiado?.cedula ?? data[0]?.paciente_beneficiado?.cedula}`;
document.getElementById("cedulaPaciente2").textContent = `${data[0]?.beneficiado?.cedula ?? data[0]?.paciente_beneficiado?.cedula}`;
document.getElementById("fechaNacimiento").textContent = `${formatToRealDate(data[0]?.beneficiado?.fecha_nacimiento) ?? formatToRealDate(data[0]?.paciente_beneficiado?.fecha_nacimiento)}`;
