...
document.getElementById("monto_sin_iva").textContent = `${data.monto_sin_iva} Bs`;
document.getElementById("monto_con_iva").textContent = `${data.monto_con_iva} Bs`;
...
document.getElementById("excento").textContent = `${data.excento} Bs`;
...
data.insumos.forEach(e => {
    document.getElementById("insumosAdquridos").innerHTML += `
        <tr class="insumo">
            ...
            <td>${e.precio_unit_bs} Bs</td>
            <td>${e.precio_total_bs} Bs</td>
        </tr>
    `
})
