...
document.getElementById("total_insumos").textContent = dataFactura.consulta_emergencia.total_insumos_bs;
document.getElementById("total_examenes").textContent = dataFactura.consulta_emergencia.total_examenes;
document.getElementById("cant_laboratorio").textContent = dataFactura.consulta_emergencia.cantidad_laboratorios;
document.getElementById("total_laboratorio").textContent = dataFactura.consulta_emergencia.laboratorios_bs;
document.getElementById("area_observacion").textContent = dataFactura.consulta_emergencia.area_observacion_bs;
document.getElementById("cant_medicamentos").textContent = dataFactura.consulta_emergencia.cantidad_medicamentos;
document.getElementById("total_medicamentos").textContent = dataFactura.consulta_emergencia.medicamentos_bs;
document.getElementById("enfermeria").textContent = dataFactura.consulta_emergencia.enfermeria_bs;
document.getElementById("cant_consultas").textContent = dataFactura.consulta_emergencia.cantidad_consultas_medicas;
document.getElementById("total_consultas").textContent = dataFactura.consulta_emergencia.consultas_medicas_bs;
