...
document.getElementById("fecha").textContent = formatToRealDate(dataConsulta[0].fecha_consulta);
...
document.getElementById("fecha_ocurrencia").textContent = formatToRealDate(dataFactura.fecha_ocurrencia);
document.getElementById("fecha_pago_limite").textContent = formatToRealDate(dataFactura.fecha_pago_limite);
