...
addEventListener("DOMContentLoaded", async e => {
    ...
    const format = (data) => {
        ...
        let examenes = data?.examenes !== undefined ? concatItems(data.examenes, "nombre", "No se realizó ningún exámen") : "No se realizó ningún exámen",
            ...
            cita_examenes = data?.cita_examenes !== undefined ? concatItems(data.cita_examenes, "nombre", "No se realizó a ningún exámen por cita", ".", "precio_examen_usd") : "No se realizó a ningún exámen por cita";
