...
//Auditoria - API
Router::get('/auditoria/consulta', AuditoriaController::class . '@listarAuditoria', [$AuthenticationMiddleware, new AuthorizationMiddleware( array("1") )]);
Router::get('/auditoria/fecha', AuditoriaController::class . '@listarAuditoriaPorFecha', [$AuthenticationMiddleware, new AuthorizationMiddleware( array("1") )]);
