...
class MedicoEspecialidadModel extends GenericModel {
    ...
    public function getCostoEspecialidad(){return $this->costo_especialidad;}
    ...
    public function setCostoEspecialidad($costo_especialidad){return $this->costo_especialidad = $costo_especialidad;}
