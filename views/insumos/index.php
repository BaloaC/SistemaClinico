...
<body>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body" id="modalRegBody">
                        ...
                        <form id="info-insumo" class="form-reg p-3 px-4">
                            ...
                            <select name="tipo_medida" class="form-control mb-3" id="tipo_medida" onchange="tipoDeMedidaHandler(this)" required>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body" id="modalActBody">
                        ...
                        <form action="" id="act-insumo" class="p-3 px-4">
                            ...
                            <label for="tipo_medida">Tipo de medida</label>
                            <select name="tipoMedida" class="form-control mb-3" id="tipo_medida" onchange="tipoDeMedidaHandler(this)" required>
                                <option value="" selected disabled>Seleccione un tipo de medida</option>
                                <option value="1">Rollo</option>
                                <option value="2">Botella</option>
                                <option value="3">Caja</option>
    ...
    <script type="module" src="<?php echo Url::to('assets/js/insumos/tipoDeMedida.js'); ?>"></script>
</body>
