                        ...
                        <div class="col-12 col-md-4 paciente-info">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <p class="text-secondary mb-0">Teléfono: <span id="telefonoPaciente"></span></p>
                                    <p class="text-secondary mb-0">Dirección: <span id="direccionPaciente"></span></p>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body" id="modalRegBody">
                        ...
                        <form id="info-antecedente" class="form-reg p-3 px-4">
                            ...
                            <textarea type="text" name="descripcion" class="form-control mb-3" data-max-length="45" required></textarea>
                        </form>
                    </div>
                    <div class="modal-footer d-flex justify-content-between">
