...
<body>
    ...
    <main>
        <div class="px-5">
            ...
            <div class="row">
                <div class="col-6">
                    <h4 class="pt-5 pb-2 text-grey">Gestión de Seguros</h4>
                </div>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body" id="modalRegBody">
                        ...
                        <form action="" id="info-seguro" class="p-3 px-4">
                            ...
                            <label for="costo_consulta">Días máximo para ingreso de clave</label>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body" id="modalActBody">
                        ...
                        <form action="" id="act-seguro" class="p-3 px-4">
                            ...
                            <label for="costo_consulta">Días máximos para ingreso de clave</label>
                            <input type="number" step="any" name="maximo_dias" class="form-control mb-3" data-validate="true" data-type="number" data-max-length="3" >
                            <small class="form-text">Solo se permiten números</small>
                        </form>
                    </div>
