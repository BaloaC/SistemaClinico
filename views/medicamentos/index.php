    ...
    <main>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body" id="modalRegBody">
                        ...
                        <form id="info-medicamento" class="form-reg p-3 px-4">
                            ...
                            <input type="text" name="nombre_medicamento" class="form-control mb-3" data-type="nameExam" data-max-length="45" required>
        ...
        <div class="modal fade" id="modalAct" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="modalActLabel" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
                <div class="modal-content">
                    <div class="modal-header">
                        <h1 class="modal-title fs-3" id="modalActLabel">Actualizar Medicamento</h1>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
